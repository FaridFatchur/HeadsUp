                ...
                <div class="container-s ms-5 border border-2 border-black">
                    <div class="product-content start-10 d-flex flex-column">
                        ...
                        <div class="container m-0 p-0">
                            <img class="object-fit-contain w-25" src="{{ asset('svg/Product_Page/Line-star-heart.svg') }}" alt="rating">
                        </div>
                        <p>WH-1000XM5 Headphone merupakan terobosan terbaru dari brand Heads Up yang memiliki berbagai fitur kekinian seperti 8D surround sound, noise reduction, serta built in flashlight</p>
                        <hr class="border border-black">
                        <h4>Warna :</h4>
                        <br>
                        <div>
                            <button type="button" class="btn active btn-light mx-2" data-bs-toggle="button">
                                <img class="" src="{{ asset('svg/Product_Page/84bedceaa11a095149c072b265f5a827 2.svg') }}" alt="oranye">
                                Oranye
                            </button>
                            <button type="button" class="btn active btn-light mx-2" data-bs-toggle="button">
                                <img class="w" src="{{ asset('svg/Product_Page/1974c08390e42efc83cbf3cfc4ed85bb 2.svg') }}" alt="biru">
                                Biru
                            </button>
                        </div>
                        <hr class="border border-black">
